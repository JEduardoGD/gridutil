...
public class GridLocatorController {
    ...
    @GetMapping("/getregionof/{gridLocator}")
    public Location getStateOfLocation(@PathVariable("gridLocator") String gridLocator) {
        return geoService.getStateOfLocation(gridLocator);
    }
}